...
export const TILES: Record<string, Tile[]> = {
  ...
  klinik: [
    ...
    { label: "Rekam medis", icon: "ti-medical-cross", ...G, href: "/klinik/rekam-medis" },
  ...
  crm: [
    ...
    // di mana keduanya sudah dipasangkan sebagai tab.
  ...
  pengaturan: [
    ...
    { label: "Penyetuju Transaksi", icon: "ti-user-check", ...A, nw: true, href: "/pengaturan/penyetuju" },
  ...
  perusahaan: [
    ...
    { label: "Persetujuan (Approval)", icon: "ti-file-check", ...P, href: "/pengaturan/penyetuju" },
  ...
  "buku-besar": [
    ...
    { label: "Transfer Anggaran", icon: "ti-arrows-transfer-down", ...G, href: "/buku-besar/transfer-anggaran" },
  ...
  pembelian: [
    ...
    { label: "Faktur Langsung (tanpa PO)", icon: "ti-receipt-2", ...G, nw: true, href: "/pembelian/faktur/langsung" },
  ...
  pos: [
    ...
    { label: "Penyelesaian Pesanan", icon: "ti-checklist", ...G, nw: true, href: "/pos/produksi" },
  ...
  laporan: [
    ...
    { label: "Rincian Penjualan per Barang", icon: "ti-package", ...A, nw: true, href: "/laporan/penjualan-barang" },
    ...
    { label: "Akuisisi Pelanggan", icon: "ti-user-plus", ...A, nw: true, href: "/laporan/akuisisi" },
    { label: "Pembelian per Pemasok & Barang", icon: "ti-truck-delivery", ...R, nw: true, href: "/laporan/pembelian" },
    { label: "Penjualan per Tenaga Penjual", icon: "ti-user-dollar", ...A, nw: true, href: "/laporan/penjual" },
    { label: "Daftar Anamnesa & Penyakit", icon: "ti-report-medical", ...A, nw: true, href: "/laporan/anamnesa" },
    { label: "Retensi Pelanggan", icon: "ti-user-exclamation", ...A, nw: true, href: "/laporan/retensi" },
    { label: "Promo, Voucher & Diskon", icon: "ti-discount", ...A, nw: true, href: "/laporan/promo" },
    { label: "Rekap Klinik", icon: "ti-stethoscope", ...A, nw: true, href: "/laporan/rekap-klinik" },
    { label: "Member & Poin", icon: "ti-users", ...A, nw: true, href: "/laporan/member" },
    ...
    { label: "Laba Ditahan", icon: "ti-pig-money", ...G, nw: true, href: "/keuangan/laba-ditahan" },
    { label: "Buku Besar", icon: "ti-book", ...G, href: "/keuangan/buku-besar" },
    { label: "Arus Kas", icon: "ti-arrows-exchange", ...G, href: "/keuangan/arus-kas" },
    { label: "Rincian Arus Kas per Rekening", icon: "ti-building-bank", ...G, nw: true, href: "/keuangan/arus-kas/rincian" },
    { label: "Piutang (AR)", icon: "ti-clock-hour-4", ...A, href: "/keuangan/piutang" },
    { label: "Buku Besar Pembantu Piutang", icon: "ti-book-2", ...A, nw: true, href: "/keuangan/piutang/pembantu" },
    { label: "Hutang (AP)", icon: "ti-clock-dollar", ...R, href: "/keuangan/hutang" },
    { label: "Buku Besar Pembantu Hutang", icon: "ti-book-2", ...R, nw: true, href: "/keuangan/hutang/pembantu" },
