...
| M40 | Laporan jumlah transaksi per cabang + rata-rata belanja per struk per cabang | P3 | ✅ | 25 Agu 2026 · `/laporan/transaksi-cabang` + `/laporan/pelanggan-harian`. Daftar 50 laporan permintaan klien ada di `docs/DAFTAR-LAPORAN-KAMO-2026-08-24.md` (43 ada, 7 belum) |
